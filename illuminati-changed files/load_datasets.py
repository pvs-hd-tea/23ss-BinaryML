...
def get_dataset(dataset_dir, dataset_name, task=None):
    ...
    elif dataset_name.lower() == "MalNetTiny".lower():
        return load_MalNetTiny(dataset_dir, 'malnettiny')
    else:
...
def load_MalNetTiny(dataset_dir, dataset_name):
    
    dataset = MalNetTiny(root=dataset_dir, name=dataset_name)
    return dataset
